...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(FN3,  FN4, FN5, FN6, FN7, FN8, FN9,FN10,FN11,FN12,FN13, DEL, \
           TRNS, F11, F12,PAUS,TRNS,TRNS,TRNS,FN16,FN17,FN18,FN19,FN14, \
           TRNS,  F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9, F10,TRNS, \
           TRNS,TRNS,TRNS,TRNS,TRNS, ESC, ESC,TRNS,TRNS,TRNS,TRNS,TRNS),

    /* 2: FN 2 */
    KEYMAP(GRV,    1,   2,   3,   4,   5,   6,   7,   8,   9,   0, DEL, \
           TRNS,TRNS,  UP,TRNS,TRNS,TRNS,TRNS,MINS, EQL,LBRC,RBRC,BSLS, \
           TRNS,LEFT,DOWN,RGHT,TRNS,TRNS,PSCR,HOME, END,PGUP,PGDN,TRNS, \
           TRNS,TRNS,TRNS,TRNS,TRNS, ESC, ESC,TRNS,TRNS,TRNS,TRNS,TRNS),
